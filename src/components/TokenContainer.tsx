...
const TokenContainer: React.FC<TokenContainerProps> = ({ tokens, onRemove, onReorder }) => {
    const [draggedToken, setDraggedToken] = useState<string | null>(null);

    const handleDragStart = (event: React.DragEvent<HTMLSpanElement>, token: string) => {
    ...
    const handleDrop = (event: React.DragEvent<HTMLSpanElement>, targetToken: string) => {
        event.preventDefault();
