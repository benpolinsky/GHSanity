...
const NotificationTypeFilter = () => {
  ...
  const dispatchFilter = (filter: NotificationType | null) =>
  ...
  return (
    <div className={styles.filterLinks}>
      ...
      <a
        href="#"
        className={typeFilter === "PullRequest" ? styles.active : ""}
        onClick={() => dispatchFilter("PullRequest")}
      >
        Pull Requests
      </a>
      <a
        href="#"
        className={typeFilter === "Issue" ? styles.active : ""}
        onClick={() => dispatchFilter("Issue")}
      >
        Issues
      </a>
      <a
        href="#"
        className={typeFilter === "Release" ? styles.active : ""}
        onClick={() => dispatchFilter("Release")}
      >
        Release
      </a>
    </div>
